# Exercice 6 - Le backend est en bonne santé mais injoignable
...
`Running` et `Ready`, et ils répondent correctement quand on les interroge
directement.
...
* même `kubectl port-forward svc/service-backend-clusterip 8080:80` refuse de
  s'ouvrir
...
* Comment un Service sait-il à quels pods envoyer le trafic ?
...
* Que raconte exactement l'échec de `kubectl port-forward` sur ce Service ?
